...
S        = load('mask_vial60percent_below4msTR.mat');
...
for indx = 1:size(mask_raw,1)
    for indy = 1:size(mask_raw,2)
...
%saveas(gcf,'Note_Experiment_3p62.png')
saveas(gcf,'Note_Experiment_3p4.png')